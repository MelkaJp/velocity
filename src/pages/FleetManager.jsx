...
export default function FleetManager() {
  const { state, CURRENCY_RATES, calculateWeeklySpend, calculateMonthlySpend, formatCurrency } = useVeloCity();
              ...
              <div className="route-list">
                {fleetVehicles.filter(v => v.type === 'truck').map(vehicle => (
                  <div key={vehicle.id} className="route-item">
                    ...
                    <button className="btn-verify-route">Verify</button>
                  </div>
                ))}
            ...
            <div className="subscription-panel">
              ...
              <div className="sub-options">
                <div className="sub-card active">
                  ...
                  <button className="btn-sub">Current Plan</button>
                </div>
                <div className="sub-card">
                  ...
                  <button className="btn-sub outline">Upgrade</button>
                </div>
              </div>
            </div>
          </motion.div>
