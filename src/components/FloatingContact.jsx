...
import { 
  MessageCircle, Send, Phone, X, MessageSquare, HelpCircle, ChevronDown, 
  Search, Mail, ThumbsUp, ExternalLink, FileText, CreditCard, Truck, 
  Shield, Fuel, User, Settings, AlertCircle, Clock
} from 'lucide-react';
      ...
      {isOpen && (
        <div className="help-panel">
          <div className="help-panel-header">
            ...
            <button className="help-panel-close" onClick={() => setIsOpen(false)}>
              <X size={18} />
            </button>
          </div>
              ...
              <div className="help-contact-list">
                {contactOptions.map((opt, idx) => (
                  <a key={idx} href={opt.href} target="_blank" rel="noopener noreferrer" className="help-contact-card" style={{ borderLeftColor: opt.color }}>
                    <div className="help-contact-icon" style={{ background: opt.color }}>
                      <opt.icon size={20} />
                    </div>
